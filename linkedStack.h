...
Description: This file contain class template for linkedStackType type, which contains both the header file information and implementation innformation.

Assistance Received: Caitlin Black

How to compile: g++ linkedList.h
...
void linkedStackType<Type>::reverseStack(linkedStackType<Type> &otherStack)
{
   ...
   otherStack = newStack;
      //received help from Caitlin Black about the while loop and  how to stat off this method's implementation
